...
While the self-service approach works fantastically for areas with a low volume of human traffic, what are the options for areas which have to process more people? Read [part 2](/media/technews/how-gt-developed-fit-for-purpose-temperature-scanners-part-2) and [part 3](/media/technews/how-gt-developed-fit-for-purpose-temperature-scanners-part-2) to find out!
