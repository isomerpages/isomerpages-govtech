...
Besides setting up stations for temperature screenings, businesses also require staff members to operate the equipment. While areas with lower footfall can tap on solutions like GovTech’s [self-service temperature scanner](/media/technews/how-gt-developed-fit-for-purpose-temperature-scanners-part-2), areas with high human traffic need a different approach to cope with the high volume.
